...
{
    public class NotEquals : IValueComparison
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool CompareU16(byte[] v1, byte[] v2) => !v1.SequenceEqual(v2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool CompareU32(byte[] v1, byte[] v2) => !v1.SequenceEqual(v2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool CompareU64(byte[] v1, byte[] v2) => !v1.SequenceEqual(v2);
